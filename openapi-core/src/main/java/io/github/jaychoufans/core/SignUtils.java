...
public class SignUtils {
	...
	public static String sign(Object object) throws NoSuchAlgorithmException, JsonProcessingException {
		...
		byte[] digested = messageDigest
				.digest(objectMapper.writeValueAsString(object).getBytes(StandardCharsets.UTF_8));
		return Hex.encodeHexString(digested);
	}

	public static String appSign(String appId, String appSecret, String nonce, String sign, String timestamp,
			String priKey) throws JsonProcessingException, NoSuchAlgorithmException, InvalidKeySpecException,
	...
	public static boolean verifyAppSign(String appId, String appSecret, String nonce, String sign, String timestamp,
			String appSign, String pubKey) throws InvalidKeyException, InvalidKeySpecException,
			NoSuchAlgorithmException, JsonProcessingException, SignatureException {
		Map<String, String> data = new TreeMap<>(String::compareTo);
		data.put("appId", appId);
		data.put("nonce", nonce);
		data.put("sign", sign);
