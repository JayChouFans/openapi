...
public class Test {
	...
	public void test() throws NoSuchAlgorithmException, JsonProcessingException, InvalidKeySpecException,
	...
	private void server(Map<String, String> header, Map<String, String> body) throws NoSuchAlgorithmException,
			JsonProcessingException, InvalidKeySpecException, SignatureException, InvalidKeyException {
		String sign = SignUtils.sign(body);
